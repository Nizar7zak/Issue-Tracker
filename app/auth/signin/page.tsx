      ...
      <Flex className="min-h-screen w-full flex-col items-center justify-center lg:flex-row lg:justify-center p-4 lg:p-8" style={{ gap: '50px' }}>
        ...
        <div className="hidden lg:flex w-6/12 justify-center items-center animate-fade-in-right">
          <div className="relative w-full max-w-xl">
            ...
            <div className="relative bg-gradient-to-br from-blue-500/10 via-indigo-600/10 to-purple-700/10 dark:from-blue-400/20 dark:via-indigo-500/20 dark:to-purple-600/20 rounded-3xl p-12 shadow-2xl border border-white/20 dark:border-slate-700/30">
              <div className="text-center">
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div className="flex items-center gap-4 p-4 bg-white/60 dark:bg-slate-800/60 rounded-xl backdrop-blur-sm">
                    ...
                    <div>
                      <Text className="font-semibold text-slate-800 dark:text-slate-200">Track Issues</Text>
                      <Text className="text-slate-600 dark:text-slate-400 text-sm">Manage your projects efficiently</Text>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-white/60 dark:bg-slate-800/60 rounded-xl backdrop-blur-sm">
                    ...
                    <div>
                      <Text className="font-semibold text-slate-800 dark:text-slate-200">Real-time Updates</Text>
                      <Text className="text-slate-600 dark:text-slate-400 text-sm">Stay updated with instant notifications</Text>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-white/60 dark:bg-slate-800/60 rounded-xl backdrop-blur-sm">
                    ...
                    <div>
                      <Text className="font-semibold text-slate-800 dark:text-slate-200">Secure & Fast</Text>
                      <Text className="text-slate-600 dark:text-slate-400 text-sm">Enterprise-grade security</Text>
                    </div>
                  </div>
                </div>
              </div>
